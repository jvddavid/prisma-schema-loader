...
index.ts (c) 2023
Desc: description
Created:  2023-02-08T12:10:38.390Z
Modified: 2023-02-08T17:12:00.901Z
*/
import fs from 'fs'
...
(async () => {
  const schemaFile = new SchemaLoader()
  const schema = await schemaFile.load('../prisma/schema.prisma')
  await schemaFile.save(schema)
})()